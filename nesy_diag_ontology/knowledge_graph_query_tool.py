...
if __name__ == '__main__':
    ...
    qt.print_res(qt.query_diag_association_by_error_code_and_sus_comp(error_code, suspect_comp_name))
    qt.print_res(qt.query_generated_heatmaps_by_error_code_and_sus_comp(error_code, suspect_comp_name))
    qt.print_res(qt.query_diag_subject_instance_by_id(dummy_id))
    qt.print_res(qt.query_error_codes_by_subject_id(dummy_id))
